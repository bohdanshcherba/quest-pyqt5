...
def counts(name_colum):
    print(df[name_colum].value_counts())
...
df.drop(["HomePlanet", "Name", "Cabin", "Destination", "PassengerId", "RoomService", "FoodCourt", "ShoppingMall", "Spa", "VRDeck"], axis=1, inplace=True)
